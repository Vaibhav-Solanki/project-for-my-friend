    ...
    <>
      <div className="theme-inner-banner">
        <div className="custom-container-one">
          ...
          <p>
            We’re happy to answer any questions you may have, get in touch and
            ...
            <div className="col-md-4">
              <div className="single-box">
                ...
                <p>
                  ...
                  <a href="tel:7000392596">+91 7000 392 596</a>
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="single-box">
                <div className="icon-box">
                  <img src={qua} alt="" className="icon" />
                </div>
                <h5 className="title font-fix">Help and Support</h5>
                <p>
                  We’re here to help with any questions. Contact us
                  <a href="tel:7000392596">Help Center</a>.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="single-box">
                ...
                <p>
                  Send an email to{" "}
                  <a href="mailto:help@1club.in">help@1club.in</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row no-gutters">
            <div className="col-md-6">
              <div className="single-block border-fix">
                ...
                <p>
                  Indore <br /> madhya pradesh, <br /> India, 451010
                </p>
              </div>
              {/* <!-- /.single-block --> */}
            </div>
            ...
            <div className="col-md-6">
              <div className="single-block">
                ...
                <p>
                  For help locating a specific department, including partnership
                  opportunities, please email{" "}
                  <a href="mailto:info@1club.in">info@1club.in</a>
                </p>
              </div>
              {/* <!-- /.single-block --> */}
            </div>

                  ...
                  <div className="text-wrapper right-space">
                    <ul>
                      ...
                      <li>
                        ...
                        <p>
                          Select between Bitcoin, Etherum or Litecoin and
                          deposit money into your Cryonik wallet.
                        </p>
                      </li>
                      <li>
                        ...
                        <p>
                          You're in charge, decide for how long you want to
                          invest and the frequency of your payouts.
                        </p>
                      </li>
                      <li>
              ...
              <div className="row single-box">
                <div className="col-lg-6 col-12 order-lg-last">
                  <div className="text-wrapper left-space space-fix">
                    ...
                    <p>
                      Bitcoin or cryptocurrency mining software is used to
                      generate new cryptocurrency and introduce components to an
                      existing Blockchain. The new cryptocurrency that is mined
                      is taken by the mining party after validation as a reward
                      for adding to the Blockchain.
                    </p>
                  </div>
                </div>
              ...
              <div className="row single-box">
                <div className="col-lg-6 col-12">
                  <div className="text-wrapper right-space">
                    ...
                    <p>
                      A crypto wallet is a place where you can securely keep
                      your crypto. There are many different types of crypto
                      wallets, but the most popular ones are hosted wallets,

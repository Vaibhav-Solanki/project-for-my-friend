    ...
    <>
      ...
      >
        ...
        <div className="card">
          ...
          refer to <b>Dr199</b>and the terms "Visitor” ”User” refer to the
          users.
          <br />
          <br />
          ...
          on this Website. The use of these properties or any other content on
          this site, except as provided in these terms and conditions or in the
          ...
          security of the Web site, including, without limitation, (1) accessing
          ...
          their use of oneclub.in or their breach of the terms . <br />
          <br />
          LIABILITY
          <br />
          <br />
          ...
          if Company has been advised of the possibility of such damages. <br />
          <br />
          ...
          not, negligent or intentional, inadvertent or advertent. <br />
          <br />
          ...
          User for all damages or/and losses or/and causes of action exceed the
          amount paid by the User to Company, if any, that is related to the
          cause of action.
          <br />
          <br />
